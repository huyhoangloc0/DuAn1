						...
						<div class="col-sm-12">
							<form:form action="/category/index" modelAttribute="category" method="post">
								<div class="row">
									<div class="col-sm-6 col-md-3">
										<div class="form-group bg-hover">
											<form:label path="id">Id <span class="text-danger">*</span></form:label> 
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-3">
										<div class="form-group bg-hover">
											<form:label path="description2">Description2</form:label> 
											<form:input class="form-control" type="text" path="description2"/>
										</div>
									</div>
									<div class="col-sm-6 col-md-3">
										<div class="form-group bg-hover">
											<form:label path="icon">Icon</form:label> 
								...
								<div class="row">
										<div class="col-sm-6 col-md-3">
											<div class="form-group bg-hover">
												<form:label path="href">Href</form:label> 
												<form:input class="form-control" type="text" path="href"/>
											</div>
										</div>
								</div>
								<div class="text-center m-t-20">
									<button class="btn btn-grey submit-btn m-r-10" formaction="/category/create" formmethod="post">Save & Send</button>
				...
				<div class="buy-form">
					...
					<form action="/category/index" method="post">
						<div class="row align-items-center">
						    ...
						    <div class="col-sm-6 col-md-3">
						        <input type="text" class="form-control" name="id" id="searchInput" value="${id}" placeholder="Enter your search term">
						    </div>
						    <div class="col-sm-6 col-md-3">
